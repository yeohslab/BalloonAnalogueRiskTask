...
- **被试内**：**开始前**先填**特质问卷**（《特质量表.md》，20 题 **1–4** 级）；每人 **2 个 block**（细、粗各 21 试次，顺序随机）；block 间有**休息**；每 block **前后**各测一次**压力量表**（与《量表,md》一致：各 **20** 题 **1–4** 级）；BART 结束后先有焦虑/难度 2 题（**1–10**），最后在汇总页前有《刺激评定量表》**2** 题（**1–4**，0.1 元与 5 元吸引力）。
...
- 编号仅用于归档（URL `?subj=` 或 `prompt`）。详见 [实验参数.md](实验参数.md)。
